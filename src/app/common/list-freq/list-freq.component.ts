...
@Component({
  ...
  imports: [AsideComponent, PesquisaComponent, ImgEditComponent, ImgDeleteComponent, ListDivComponent,
    ReorganizesMainComponent, TitlesComponent, ReorganizeInputComponent, ImgViewComponent, TableComponent, TablerowComponent, TableHeaderComponent, TableCellComponent],
